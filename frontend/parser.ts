import { Statement, Program, Expr, BinaryExpr, NumericLiteral, Identifier, VarDeclaration, AssignmentExpr, Property, ObjectLiteral, CallExpr, MemberExpr } from "./ast.ts";
  ...
  private parse_member_expr(): Expr {
    ...
    while(this.at().type == TokenType.Dot || this.at().type == TokenType.Openbracket) {
      ...
      if(operator.type == TokenType.Dot){
        ...
        //this allows obj[computedValue] / chain
        computed = true;
